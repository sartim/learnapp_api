...
Revision ID: 084022c7f6cf
Revises: 
Create Date: 2019-04-18 15:13:17.456957
...
def upgrade():
    ...
    sa.Column('started_date_time', sa.DateTime(), nullable=True),
    sa.Column('ended_date_time', sa.DateTime(), nullable=True),
    ...
    op.create_table('quiz_question_choice',
    sa.Column('question_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('quiz_question_choice')
